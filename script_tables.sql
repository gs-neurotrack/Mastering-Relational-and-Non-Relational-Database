...
CREATE TABLE GS_BEHAVIOR_DATA (
  ID_BEHAVIOR  NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY NOT NULL,
  AVG_TYPING_SPEED  FLOAT(4) NOT NULL,
  CLICKS_PER_MIN NUMBER(3) NOT NULL,
  AVG_TOUCH_PRESSURE  FLOAT(2) NOT NULL,
  AVG_TOUCH_DURATION  FLOAT(4) NOT NULL, 
  DOUBLE_CLICK_RATE NUMBER(3) NOT NULL,
  DATE_LOG DATE NOT NULL,
  SESSION_DURATION  DATE NOT NULL,
  ID_USER NUMBER NOT NULL,
  CONSTRAINT FK_BEHAVIOR_USER FOREIGN KEY (ID_USER)
